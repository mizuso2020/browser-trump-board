...
### 2026-07-19 時点 — 遊べる / 遊べない

詳細表は **[CHANGELOG.md（2026-07-19 時点）](CHANGELOG.md#2026-07-19-時点--遊べるゲーム--遊べないゲーム)** を参照。

| 区分 | 数 | 内容 |
|------|----|------|
| **遊べる** | **16** | 人狼・お絵描き人狼・ワードウルフ・NGワード・ナンバーリンク・大富豪・爆弾・BJ・99・テキサス・オセロ・五目・将棋・○×3種 |
| **準備中（遊べない）** | **15** | ダウト・コヨーテ・コードネーム・カタン・ディクシット・ババ抜き・七並べ・神経衰弱・スピード・チェス など |

- トランプ系の一部（大富豪・爆弾・BJ・99・テキサス）は **各自のスマホのみ**
- **オンライン**は全タイトル準備中

### Version 1（v1.0.0 / 2026-07-12）時点で遊べたのは 9 タイトル
